...
extra_config_file = '@extraConfigFile@'
menuentry_config = {
  "icon": '@menuEntryConfigIcon@',
  "format": '@menuEntryConfigFormat@',
  "date_format": '@menuEntryConfigDateFormat',
  "extra_options": "@menuEntryConfigExtraOptions"
}
submenuentry_config = {
  "icon": '@subMenuEntryConfigIcon@',
  "format": '@subMenuEntryConfigFormat@',
  "date_format": '@subMenuEntryConfigDateFormat',
  "extra_options": "@subMenuEntryConfigExtraOptions"
}
...
def generation_details(profile, generation):
    kernel = copy_from_profile(profile, generation, "kernel", True)
    initrd = copy_from_profile(profile, generation, "initrd", True)
