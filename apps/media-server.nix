...
whenMediaServer {
  ...
  networking.firewall.allowedTCPPorts = [ 22 80 8080 8688 8443 8006 8005 32400 9091 4000 4001 4002 111 ];
  networking.firewall.allowedUDPPorts = [ 4000 4001 4002 111 ];
