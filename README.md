...
Opinionated nixos configuration with support for somewhat useflags on "world" level, custom overlaying (see [unstables](./overlays/unstables.nix) as an example)
